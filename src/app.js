...
const Body = () => {
  return (
    <div className="card-container">
      {/* <RestaurantCard {...restraunList[0].data} />
      <RestaurantCard {...restraunList[1].data} />
      <RestaurantCard {...restraunList[2].data} />
      <RestaurantCard {...restraunList[3].data} />
      <RestaurantCard {...restraunList[4].data} />
      <RestaurantCard {...restraunList[5].data} />
      <RestaurantCard {...restraunList[6].data} />
      <RestaurantCard {...restraunList[7].data} />
      <RestaurantCard {...restraunList[8].data} /> */}
      {restraunList.map((restaurant) => {
